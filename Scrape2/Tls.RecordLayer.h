...
namespace Tls
{
    ...
    class RecordLayer : public StateMachine, public ArrayStream<byte>, public ITransportEventHandler<byte>
    {
    private:
        enum State
        {
        ...
        std::weak_ptr<ITransportEventHandler<byte> > application_stream;
    ...
    public:
        ...
        RecordLayer(std::shared_ptr<ITransportEventHandler<byte> > application_stream, bool server, std::shared_ptr<ICertificate> certificate);
