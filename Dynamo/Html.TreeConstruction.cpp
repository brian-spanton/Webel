...
namespace Html
{
	...
	{
		HandleNyi("TreeConstruction::adjust_MathML_attributes", true); // $
	}

	void TreeConstruction::adjust_SVG_attributes(TagToken* token)
	{
		HandleNyi("TreeConstruction::adjust_SVG_attributes", true); // $
	}

	void TreeConstruction::adjust_foreign_attributes(TagToken* token)
	{
		HandleNyi("TreeConstruction::adjust_foreign_attributes", true); // $
	}
	...
	void TreeConstruction::create_an_element_for_a_token(TagToken* token, UnicodeString* name_space, ElementNode::Ref* element)
	{
		...
		HandleNyi("TreeConstruction::create_an_element_for_a_token", false); // $
	...
	{
		HandleNyi("TreeConstruction::perform_a_microtask_checkpoint", false); // $
	}

	void TreeConstruction::provide_a_stable_state()
	{
		HandleNyi("TreeConstruction::provide_a_stable_state", false); // $
	}
	...
	void TreeConstruction::insert_a_foreign_element(TagToken* token, UnicodeString* name_space)
	{
		...
		HandleNyi("TreeConstruction::insert_a_foreign_element", true); // $
	}
	...
	{
		HandleNyi("TreeConstruction::foster_parent", true); // $
	}
...
step_8:
	...
	void TreeConstruction::in_table_insertion_mode_anything_else(TokenPointer token)
	{
		...
		HandleNyi("TreeConstruction::in_table_insertion_mode_anything_else", true); // $
	}
...
loop:
	...
	Document::Mode TreeConstruction::QuirksMode(DocTypeToken* doctype_token)
	{
		...
		HandleNyi("TreeConstruction::QuirksMode", false); // $
...
#undef CASE
	...
	void TreeConstruction::stop_parsing()
	{
		...
		HandleNyi("TreeConstruction::stop_parsing", false); // $
