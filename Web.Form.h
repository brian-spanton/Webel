...
namespace Web
{
    ...
    {
    public:
        typedef Basic::Ref<Form> Ref; // REF
        ...
        Basic::Ref<ElementNode> form_element; // REF
        Html::ElementList controls;

        void Initialize(ElementNode* element);
        bool Submit(Web::Client* client, IProcess* client_completion, ByteString* client_cookie);
    ...
    typedef std::vector<Form::Ref> FormList; // REF
}
